...
// double right_p_a[6];
    ...
    double left_p_a[6] = {-1.5708, 0.0, 0.0, 0.0 ,450, 0.0};
    double right_p_a[6] = {1.5708, 0.0, 0.0, 0.0 ,-450, 0.0};
...
// mj_data->time - simstart
    ...
    Eigen::VectorXd motors_pos(7);
            ...
            if (left_angles_tested[7] == 0.0)
            {
                ...
                std::cout<<left_angles[4]<<std::endl;
                
            }
            else
            {
                std::cout<<"left::"<<simTime<<" "<<left_angles_tested[7]<<std::endl;
            }
